 ...
 */
AfpAPNS.prototype.send = function (data, devices) {
...
if (typeof process !== 'undefined' && process.env.NODE_ENV === 'test') {
	AfpAPNS.generateNotification = generateNotification;
	AfpAPNS.chooseConns = chooseConns;
	AfpAPNS.handleTransmissionError = handleTransmissionError;
}
module.exports = AfpAPNS;
