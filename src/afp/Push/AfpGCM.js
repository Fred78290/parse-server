...
function AfpGCM(args) {
	if (typeof args !== 'object' || !args.apiKey || !args.bundleId) {
 ...
 */
AfpGCM.prototype.send = function (data, devices) {
...
if (typeof process !== 'undefined' && process.env.NODE_ENV === 'test') {
	AfpGCM.generateGCMPayload = generateGCMPayload;
	AfpGCM.sliceDevices = sliceDevices;
}
module.exports = AfpGCM;
